...
/**
 * The Compare page.
 * Displays a global comparison of voter list maintenance rules (India, USA, UK).
 *
 * @returns {JSX.Element} The rendered Compare component.
 */
        ...
        <table className="w-full text-left bg-white dark:bg-slate-800 border-collapse">
          <thead>
            <tr className="bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300">
              <th className="p-4 border-b border-slate-200 dark:border-slate-700 font-bold w-1/4">
                Process / Country
              </th>
          ...
          <tbody className="text-slate-600 dark:text-slate-400">
            <tr>
              <td className="p-4 border-b border-slate-200 dark:border-slate-700 font-semibold bg-slate-50 dark:bg-slate-900/50">
                {isSimpleMode
                  ? 'How they clean the voter list'
                  : 'Roll Maintenance Mechanism'}
              </td>
